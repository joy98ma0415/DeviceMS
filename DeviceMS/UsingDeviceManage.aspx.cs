...
namespace DeviceMS
{
    public partial class UsingDeviceManage : System.Web.UI.Page
    {
        ...
        protected void Btn_Query_Click(object sender, EventArgs e)
        {
            ...
            string usePlace = this.UsePlace.SelectedValue;
            DataSet ds = UsingDeviceDAO.QueryDeviceInfo(deviceName, typeId, usePlace);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                TypeName.Text = UsingDeviceDAO.GetDeviceTypeName(id);
